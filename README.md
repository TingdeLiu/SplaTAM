...
<style>
.lang { display: none; }
.lang-switch { display: flex; gap: 10px; justify-content: center; margin: 12px 0 4px; }
.lang-switch label { cursor: pointer; padding: 6px 12px; border: 1px solid #ccc; border-radius: 6px; font-weight: 600; background: #f8f8f8; }
#lang-zh:checked ~ .content .zh { display: block; }
#lang-en:checked ~ .content .en { display: block; }
#lang-zh:checked ~ .content .lang-switch label[for="lang-zh"],
#lang-en:checked ~ .content .lang-switch label[for="lang-en"] { border-color: #444; background: #e8e8e8; }
</style>
  ...
  <div class="lang en">
    <details open style='padding: 10px; border-radius: 5px 30px 30px 5px; border: 1px solid #ddd;'>
      ...
      <ol>
        ...
        <li><a href="#demo-en">Demo</a></li>
        <li><a href="#usage-en">Usage</a></li>
        <li><a href="#downloads-en">Downloads</a></li>
        <li><a href="#benchmarking-en">Benchmarking</a></li>
        <li><a href="#acknowledgement-en">Acknowledgement</a></li>
        <li><a href="#citation-en">Citation</a></li>
        <li><a href="#developers-en">Developers</a></li>
      </ol>
    </details>
    ...
    **Extras**
    ...
    <h2 id="installation-en">Installation</h2>
    ...
    **Docker / Singularity**
    ...
    <h2 id="downloads-en">Downloads</h2>
    ...
    <h2 id="benchmarking-en">Benchmarking</h2>
    ...
    <h2 id="acknowledgement-en">Acknowledgement</h2>
    - 3D Gaussians: [Dynamic 3D Gaussians](https://github.com/JonathonLuiten/Dynamic3DGaussians), [3D Gaussian Splatting](https://github.com/graphdeco-inria/gaussian-splatting)
    - Dataloaders: [GradSLAM & ConceptFusion](https://github.com/gradslam/gradslam/tree/conceptfusion)
    - Baselines: [Nice-SLAM](https://github.com/cvg/nice-slam), [Point-SLAM](https://github.com/eriksandstroem/Point-SLAM)

    <h2 id="citation-en">Citation</h2>
    ...
    <h2 id="developers-en">Developers</h2>
    - [Nik-V9](https://github.com/Nik-V9) (Nikhil Keetha)
    - [JayKarhade](https://github.com/JayKarhade) (Jay Karhade)
  </div>
</div>
